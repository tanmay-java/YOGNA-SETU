  ...
  return (
    <footer className="bg-gray-900 border-t border-gray-800 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              A comprehensive platform dedicated to helping citizens discover and apply for government schemes that empower their lives and communities.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/home" className="text-base text-gray-400 hover:text-white transition-colors">
                  Home
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/signin" className="text-base text-gray-400 hover:text-white transition-colors">
                  Citizen Login
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-3 text-base text-gray-400">
                ...
                <span>1800-111-222 (Toll Free)</span>
              </li>
              <li className="flex items-center gap-3 text-base text-gray-400">
                <Mail className="h-5 w-5 text-gray-500" />
                <span>support@yojanasetu.gov.in</span>
              </li>
              <li className="flex items-start gap-3 text-base text-gray-400">
                <ExternalLink className="h-5 w-5 text-gray-500 mt-1" />
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center bg-">
          <p className="text-base text-gray-400">
            &copy; {new Date().getFullYear()} Yojana Setu Platform. All rights reserved.
          </p>
